      ...
      private void AfficherLeTop()
      {
         try
         {
            ...
            if (OraRead.Read())
            {
               ...
               PB_Gold_Image.ImageLocation = AppDomain.CurrentDomain.BaseDirectory + "..\\..\\Affiches\\" + OraRead.GetString(2);
               PB_Gold_Image.SizeMode = System.Windows.Forms.PictureBoxSizeMode.Zoom;
            }
            else
            {
            ...
            if (OraRead.Read())
            {
               ...
               PB_Silver_Image.ImageLocation = AppDomain.CurrentDomain.BaseDirectory + "..\\..\\Affiches\\" + OraRead.GetString(2);
               PB_Silver_Image.SizeMode = System.Windows.Forms.PictureBoxSizeMode.Zoom;
            }
            else
            {
            ...
            if (OraRead.Read())
            {
               ...
               PB_Bronze_Image.ImageLocation = AppDomain.CurrentDomain.BaseDirectory + "..\\..\\Affiches\\" + OraRead.GetString(2);
               PB_Bronze_Image.SizeMode = System.Windows.Forms.PictureBoxSizeMode.Zoom;
            }
            else
            {
